...
│   └── gifts-debug.sh        # Operator CLI: list, set role, unlink Lightning Address, messages, external-pubkeys, video-put, restore, spend, trust-edge, trust-edge-delete (DEBUG_TOKEN)
├── e2e/
