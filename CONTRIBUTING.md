...
│   └── gifts-debug.sh        # Operator CLI: list, set role, unlink Lightning Address, messages, video-put, spend, trust-edge (DEBUG_TOKEN)
├── e2e/
