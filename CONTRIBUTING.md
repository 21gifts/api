...
| `NOSTR_PUBLISH_PUBLIC` | _(unset → space-only published)_        | Set to `1` (with `NOSTR_PUBLISH=1`) to also write kind:1 to Damus / Primal / nos.lol. Unset: space ACK is terminal `published`. Does not gate zap ingest or invoice `relays`.                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `NOSTR_RELAY_PUBLIC`   | Damus, Primal, nos.lol                  | Optional comma-separated public relays. Used for kind:1 write when `NOSTR_PUBLISH_PUBLIC=1`, and always for zap ingest plus invoice `relays` tags (even when that flag is off).                                                                                                                                                                                                                                                                                                                                                                                                                                          |
