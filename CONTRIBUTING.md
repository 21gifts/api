...
│   └── gifts-debug.sh        # Operator CLI: list, set role, unlink Lightning Address, messages, video-put, restore, spend, trust-edge (DEBUG_TOKEN)
├── e2e/
