...
│   │   ├── nostr/            # Custodial nsec, kind:0 profile + NIP-65 kind:10002 + kind:1 note worker, NIP-57 zap, write-set relays
│   │   └── auth/
...
| `NOSTR_PUBLISH`        | _(unset → sign only)_                   | Set to `1` to fan out signed kind:1 notes, replaceable kind:0 profiles, and replaceable kind:10002 relay lists over WebSockets. Unchanged kind:0 content and unchanged kind:10002 write-URL lists are skipped for the life of the AuthStore instance. Other values do not publish.                                                                                                                                                                                                                                                                                                                                       |
