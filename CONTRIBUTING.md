...
`NOSTR_PUBLISH_PUBLIC`, `NOSTR_RELAY_SPACE`, and `NOSTR_RELAY_PUBLIC` to blank
...
| `NOSTR_RELAY_SPACE`    | nostr.space (prd) / dev-relay (dev)     | Optional durability relay WebSocket URL override.                                                                                                                                                                                                                                                                                                                                                                                                                                 |
