...
Playwright also pins `NIP57_PROBE` to `0` so `POST /debug/accounts` can provision
without a live zap-capable LNURL.
...
| `NIP57_PROBE`          | _(unset → probe on)_                    | Set to `0` to skip the NIP-57 mint probe on `POST /debug/accounts` (e2e only). Unset or any other value probes. Production must not set this. Playwright pins `0`. Not a secret. Not required at boot.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
