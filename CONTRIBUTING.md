...
│   │   ├── debug.ts          # GET+PATCH /debug/accounts (operator DEBUG_TOKEN)
...
│   └── gifts-debug.sh        # Operator CLI for GET/PATCH /debug/accounts
├── e2e/
...
| `DEBUG_TOKEN`          | _(unset → debug off)_                   | Operator bearer for `GET`/`PATCH /debug/accounts` and `GET /debug/contacts`. Unset or blank → `503`; the process still boots.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
