...
| `DEBUG_TOKEN`           | _(unset → debug off)_                   | Operator bearer for `GET /debug/accounts`, `GET /debug/accounts/:id`, `POST /debug/accounts`, `PATCH /debug/accounts/:id`, `POST /debug/accounts/:id/session`, `GET /debug/contacts`, `GET /debug/api-log`, `GET /debug/invoices`, `POST /debug/invoices/settle`, `GET /debug/zap-ingests`, `GET /debug/messages`, `GET /debug/messages/:id`, `GET /debug/messages/:id/photo`, `PUT /debug/messages/:id/video`, `POST /debug/messages/:id/restore`, `GET /debug/external-pubkeys`, `POST /debug/push-ping`, `GET /debug/trust-edges`, `POST /debug/trust-edges`, `DELETE /debug/trust-edges`, `GET /debug/dump`, and `GET /debug/dump/:table`. Unset or blank → `503`; the process still boots.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
