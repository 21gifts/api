...
| `DEBUG_TOKEN`           | _(unset → debug off)_                   | Operator bearer for `GET /debug/accounts`, `POST /debug/accounts`, `PATCH /debug/accounts/:id`, `POST /debug/accounts/:id/session`, `GET /debug/contacts`, `GET /debug/api-log`, `GET /debug/invoices`, `POST /debug/invoices/settle`, `GET /debug/zap-ingests`, `GET /debug/messages`, `GET /debug/messages/:id`, `GET /debug/messages/:id/photo`, `PUT /debug/messages/:id/video`, `POST /debug/messages/:id/restore`, `GET /debug/external-pubkeys`, `POST /debug/push-ping`, `POST /debug/trust-edges`, and `DELETE /debug/trust-edges`. Unset or blank → `503`; the process still boots.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
