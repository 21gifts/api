...
| `DEBUG_TOKEN`          | _(unset → debug off)_                   | Operator bearer for `GET /debug/accounts`, `PATCH /debug/accounts/:id`, `GET /debug/contacts`, `GET /debug/invoices`, and `GET /debug/zap-ingests`. Unset or blank → `503`; the process still boots.                                                                                                                                                                                                                                                                                                                                                                                                                    |
