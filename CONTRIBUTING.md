...
│   │   ├── conversations.ts  # GET/POST /conversations, GET/POST /conversations/:id, POST /conversations/:id/read, POST /conversations/:id/invoice
