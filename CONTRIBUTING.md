...
│   │   ├── debug-messages.ts # GET /debug/messages, GET /:id, GET /:id/photo; PUT /:id/video (operator DEBUG_TOKEN)
...
│   │   ├── boot-stores.ts    # DATABASE_URL → auth, optional QueryGiftStore + SqlGiftRecorder, message, contact, conversation, notification, push, BTC-USD rates, KEK, db_change
...
│   └── gifts-debug.sh        # Operator CLI: list, set role, unlink Lightning Address, messages, video-put (DEBUG_TOKEN)
├── e2e/
...
| `SPEND_API_TOKEN`      | _(none — optional)_                     | Bearer for spend-worker `GET /invoices/passkey`, `GET /invoices/posted`, `POST /invoices`, and `POST /invoices/proof`. Unset/blank → **503**; the process still boots.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
