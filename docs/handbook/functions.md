...
- **Payment-claim backfill:** After constructing `PostgresMessageStore`, runs `backfillZapPayments` before constructing the remaining Postgres stores and returning. In-memory boots never call the backfill.
