...
**Daily gifts (operator, no HTTP):** when `LNDHUB_*`, `DAILY_GIFTS_RECIPIENTS`,
rate corridor, cap, and `DAILY_GIFTS_LOG_PATH` are set, the process runs a
fail-closed payout once per day at 20:00 Europe/Zurich (see CONTRIBUTING).
