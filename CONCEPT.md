...
- The auth callback host pins the `linkingKey` domain and is **fixed from day
  one**: `api.21.gifts` (PRD) / `dev-api.21.gifts` (DEV). Changing this host
  later would invalidate every account identity.
