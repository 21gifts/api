...
verified, we will work on a fix and coordinate disclosure with you.

## Scope

In scope:

- This service (`api`) and any subdomain it serves
- The web frontend at [`21gifts/app`](https://github.com/21gifts/app)
