...
| GET    | `/messages`                                          | Bearer                     | List top-level forum notes (+ visible `replyCount`); 409 if rules missing; profile notes (account.profile_message_id) are omitted            |
